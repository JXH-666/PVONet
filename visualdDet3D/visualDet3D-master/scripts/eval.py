...
def main(config:str="config/monoflex.py",
        gpu:int=0, 
        checkpoint_path:str="/home/optobot-01/haosenWang/code/visualDet3D-master/workdirs/MonoFlex/checkpoint/MonoFlex_latest.pth",
